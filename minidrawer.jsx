      ...
      <AppBar position="fixed">
        <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <Typography variant="h6" noWrap
                sx={{ 
                  fontWeight: 600, letterSpacing: "1px", color: "#bbdefb", textShadow: "0 0 8px rgba(0,150,255,0.8)"
                }}
              >
                Dashboard
          </Typography>
          ...
          {/* LOGIN BUTTON */}
          <Button variant="outlined" color="info" startIcon={<LoginIcon />} onClick={() => history.push("/login")}
                sx={{ borderColor: "#00b0ff", color: "#80d8ff",
                  '&:hover': {
                    borderColor: "#4fc3f7",
                    boxShadow: "0 0 10px rgba(0,150,255,0.7)"
                  }
                }}
              >
                Login
